...
def db_retriever(project_name=None):
    ...
    CHROMA_DIR_3 = "vector_store/grain_meetings"

    # Not using anymore, instead reports are generated.
    ...
    retriever3 = db3.as_retriever(search_kwargs={"k": 3, "filter": {"project_name": project_name}})
